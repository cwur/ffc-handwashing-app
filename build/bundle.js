var app = (function () {
    ...
    /* src/HowTo.svelte generated by Svelte v3.25.1 */
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.25.1 */
    ...
    /* src/Timer.svelte generated by Svelte v3.25.1 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			button.disabled = /*timerRunning*/ ctx[1];
    			attr(button, "class", "start svelte-paji7y");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*startTimer*/ ctx[3], { once: true });
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*timerRunning*/ 2) {
    				button.disabled = /*timerRunning*/ ctx[1];
    			}
    		},
    		i(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const startTimer = () => {
    		$$invalidate(1, timerRunning = true);
    		...
    		const timer = setInterval(
    			() => {
    				...
    				if (secondsLeft === 0) {
    					clearInterval(timer);
    					$$invalidate(1, timerRunning = false);
    					$$invalidate(0, secondsLeft = initialSeconds);
    				}
    			},
    			1000
    		);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, progress = (initialSeconds - secondsLeft) / initialSeconds * 100);
    		}
    	};

    	return [secondsLeft, timerRunning, progress, startTimer];
    }
